...
const MOCK_LOTS: Lot[] = [
  {
    id: 'L-1001', source: 'etender', url: 'https://etender.uzex.uz/lots/2/1001',
    ...
    category: 'Авто и шины', buyer: 'МВД РУз', region: 'Ташкент',
    budget_amount: 950_000_000, currency: 'UZS',
    bid_deadline_at: new Date(Date.now() + 1000*60*60*28).toISOString(),
    published_at: new Date(Date.now() - 1000*60*60*20).toISOString(),
    status: 'open',
  },
  {
    id: 'L-1002', source: 'xarid', url: 'https://xarid.uzex.uz/lots/2/1002',
    title: 'Рукава всасывающие D125 мм, 4 м',
    description: 'Рукав всасывающий для забора воды, 2025 г.в., новый, без повреждений.',
    category: 'Пожарная безопасность', buyer: 'Министерство по ЧС', region: 'Самарканд',
    budget_amount: 320_000_000, currency: 'UZS',
